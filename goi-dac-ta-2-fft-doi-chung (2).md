...
$$
k = \operatorname{round}\!\left(\frac{f \cdot N}{f_s}\right)
$$
...
\text{sai lệch}_\% = \frac{f_k - f}{f}\times 100
$$
...
$$
k_{\text{exact}} = \frac{770 \times 256}{8000} = 24.640 \ \Rightarrow\ k = \operatorname{round}(24.640) = 25
$$
